...
class hyperdata:
    ...
    def __init__(self, sex, age, on_thyroxine, query_on_thyroxin, on_antythyroid_medication, thyroid_surgery, query_hypothyroid, query_hyperthyroid, pregnant, sick, tumor, lithium, goitre, TSH_measured, TSH, T3_measured, T3, TT4_measured, TT4, FTI_measured, FTI, TBG_measured, TBG, Il3l_treatment, hypopituitary, psych):
        self.Sex = sex
        self.Age = age
        self.on_thyroxine = on_thyroxine
        self.query_on_thyroxine = query_on_thyroxin
        ...
        self.TBG_measured = TBG_measured
        self.TBG = TBG
        self.Il3l_treatment = Il3l_treatment
