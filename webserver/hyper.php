...
<div class="container">
  ...
  <form>
	...
	<div class="form-group">
      <label for="sel1">Pacientul sufera de psihoza?</label>
	  <br>
      <select name="psych" id="psych" onchange="" class="form-control" style="width:150px;">
        <option value="t">Da</option>
        <option value="f">Nu</option>
      </select>
      <br>
	...
	<div class="form-group">
      <label for="sel1">Pacientul sufera de hipopituitarism?</label>
	  <br>
      <select name="hypopituitary" id="hypopituitary" onchange="" class="form-control" style="width:150px;">
        <option value="t">Da</option>
        <option value="f">Nu</option>
      </select>
      <br>
	...
	<div class="form-group">
      <label for="sel1">Pacientul a fost tratat cu I131?<label>
	  <br>
      <select name="Il3l_treatment" id="Il3l_treatment" onchange="" class="form-control" style="width:150px;">
        <option value="t">Da</option>
        <option value="f">Nu</option>
      </select>
      <br>
  ...
  <button id="datasendbutton" type="button" onclick="sendandChangeDataHyper()" style="margin-top:5%;" class="btn btn-primary btn-lg">Trimite datele</button>
  <br>
  <br>
